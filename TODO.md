...
- [ ] **Generic off-domain redirect** — редирект на домен, отличный от
      запрошенного, как мягкий признак ISP-заглушки (в дополнение к списку
      известных маркеров). Осторожно с ложными срабатываниями (легитимные
      cross-domain редиректы вроде consent-страниц).
- [ ] **Расширить окно DPI data-limit** до 10240..25600 Б (сейчас 15000..21000)
      — ловит больше вариаций «обрыва после ~16-20КБ».
