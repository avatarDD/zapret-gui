...
const Help = (() => {
    ...
    register('strategies', {
        ...
        body: 'Стратегия — набор аргументов nfqws2 для обхода DPI. ' +
              ...
              'стратегии» (показывается, когда что-то выучено): таблица домен → ' +
              'номер подстратегии. Кнопка «↻ мусорка» сбрасывает запись по одному ' +
              'домену — circular переберёт стратегии заново на новых соединениях. ' +
              'Бейджи категорий в шапке сбрасывают группу (yt_tcp/rkn_tcp/...).<br><br>' +
