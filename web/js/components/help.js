...
const Help = (() => {
    ...
    register('blockcheck2', {
        ...
        body: 'Запускает ШТАТНЫЙ скрипт <code>blockcheck2.sh</code> из ' +
              ...
              'рабочие приёмы показываются кликабельными бейджами <b>по мере ' +
              'нахождения</b> — сразу же, не дожидаясь окончания всех тестов ' +
              '(вывод скрипта идёт через PTY и стримится построчно). Клик ' +
