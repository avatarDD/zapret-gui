    ...
    function renderWatchdog() {
        ...
        box.innerHTML = `
            ...
            <p class="text-muted" style="font-size:12px; margin:6px 0 0;">
                ...
                трафика. Дополнительно: если туннель с
                <b>автозапуском</b> совсем упал (демон/интерфейс умер) —
                поднимает его заново. PersistentKeepalive&nbsp;=&nbsp;25
                теперь проставляется новым конфигам автоматически (держит
                NAT-binding живым, чтобы зависание ловилось и в простое).
            </p>
