...
угадывать имена пакетов И правильный менеджер (opkg на 24.10 и раньше, apk
на 25.12+ и в SNAPSHOT). Этот модуль:
...
def detect_pkg_manager():
    ...
    kind ∈ {"apk", "opkg"}. На apk-based OpenWrt (25.12+/SNAPSHOT) предпочитаем apk,
