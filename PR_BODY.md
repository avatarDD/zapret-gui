...
- 6 встроенных провайдеров: Cloudflare, Google, AdGuard, Quad9, Yandex, Comss
- Быстрые пресеты (YouTube → Cloudflare, Telegram → Cloudflare, Discord → Cloudflare)
- dnsmasq интеграция (генерирует server= директивы)
- GUI: CRUD правил, кнопка «Применить», пресеты
...
### 13. Dashboard объединённый обзор
...
web/js/pages/tunnel_optimizer.js   web/js/pages/dns_routing.js
```

### Модифицированные файлы (27):
```
